...
def main():
    st.title("Photo Editor using GANs")
    """This project demonstrates the use of GANs for editing the faces in the photos uploaded. One can use the sliders at the left panel to play with the image."""
    ...
    st.sidebar.write(
    """Move the slider to change the values for the various features and observe the changes in the image."""
    )
    seed = 27834096
